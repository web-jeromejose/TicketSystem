...
var KTLayoutBuilder = function () {
    ...
    // Private functions
    var urlMetronic = "https://keenthemes.com/metronic/preview/demo1/";
    var preview = function () {
        $('[name="builder_submit"]').click(function (e) {
            ...
            console.log(urlMetronic);
            console.log($(_self).data('demo'));
            $.ajax(urlMetronic + 'index.php?demo=' + $(_self).data('demo'), {
                method: 'POST',
                data: $('[name]').serialize(),
            }).done(function (r) {
